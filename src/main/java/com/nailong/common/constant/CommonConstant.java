...
public class CommonConstant {
    ...
    public static final String UTF_8 = "UTF-8";  ///< 字符编码相关常量
    public static final String GBK = "GBK";
    
    public static final String HTTP_METHOD_GET = "GET";  ///< HTTP请求相关常量
    public static final String HTTP_METHOD_POST = "POST";
    public static final String HTTP_METHOD_PUT = "PUT";
    public static final String HTTP_METHOD_DELETE = "DELETE";
    
    public static final String HEADER_USER_AGENT = "User-Agent";  ///< HTTP请求头相关常量
    public static final String HEADER_CONTENT_TYPE = "Content-Type";
    public static final String HEADER_AUTHORIZATION = "Authorization";
    public static final String HEADER_X_REQUESTED_WITH = "X-Requested-With";
    public static final String HEADER_X_FORWARDED_FOR = "X-Forwarded-For";
    
    public static final String CONTENT_TYPE_JSON = "application/json";  ///< 内容类型相关常量
    public static final String CONTENT_TYPE_FORM = "application/x-www-form-urlencoded";
    public static final String CONTENT_TYPE_MULTIPART = "multipart/form-data";
    
    public static final String DATE_FORMAT_YMD = "yyyy-MM-dd";  ///< 时间格式相关常量
    ...
    public static final Integer DEFAULT_PAGE_NUM = 1;  ///< 分页相关常量
    public static final Integer DEFAULT_PAGE_SIZE = 10;
    public static final Integer MAX_PAGE_SIZE = 100;
    
    public static final String USER_DEFAULT_AVATAR = "default_avatar.png";  ///< 用户相关常量
    public static final String USER_DEFAULT_NICKNAME = "用户";
    
    public static final Integer STATUS_ENABLE = 1;  ///< 状态相关常量
    public static final Integer STATUS_DISABLE = 0;
    
    public static final Integer GENDER_UNKNOWN = 0;  ///< 性别相关常量
    public static final Integer GENDER_MALE = 1;
    public static final Integer GENDER_FEMALE = 2;
    
    public static final Integer DELETED_NO = 0;  ///< 逻辑删除相关常量
    public static final Integer DELETED_YES = 1;
    
    public static final String SYMBOL_COMMA = ",";  ///< 符号相关常量
    ...
    public static final String PATH_SEPARATOR = "/";  ///< 路径相关常量
    public static final String PATH_TEMP = "/temp";
    public static final String PATH_UPLOAD = "/upload";
    public static final String PATH_STATIC = "/static";
    
    public static final String EMPTY_STRING = "";  ///< 其他常用常量
    ...
    public static final String REGEX_EMAIL = "^[a-zA-Z0-9_-]+@[a-zA-Z0-9_-]+(\\.[a-zA-Z0-9_-]+)+$";  ///< 正则表达式相关常量
    ...
    public static final String PROBLEM_TYPE_SINGLE = "single";  ///< 题目相关常量
    ...
    public static final String DIFFICULTY_EASY = "easy";  ///< 难度等级相关常量
    public static final String DIFFICULTY_MEDIUM = "medium";
    public static final String DIFFICULTY_HARD = "hard";
    
    public static final String DIRECTION_FRONTEND = "frontend";  ///< 方向相关常量
